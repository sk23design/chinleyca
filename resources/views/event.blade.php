...
<main>
    <header class="relative bg-cool-gray-100 lg:bg-gray-50">
        ...
        <div
            class="relative  -mt-15 sm:mt-0 w-full sm:h-72 md:h-96 lg:h-full lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2 bg-white">
            <picture>
    ...
    <div class="mt-12 lg:mt-24 relative max-w-screen-xl mx-auto">
        ...
        <div class="px-4 py-8 sm:px-6 sm:py-12 lg:py-16 lg:mr-1/2 lg:pr-12">
            ...
            <p class="mt-12 text-xs leading-4 text-gray-500">
                <cite class="not-italic">² Marchex - “Spam Phone Calls Cost U.S. Small Businesses Half-Billion
                    Dollars
