        ...
        <div class="gallery p-4">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-7xl mx-auto px-8 mt-2">
                ...
                <img class="object-cover  rounded-xl  shadow-xl" src="{{asset('storage/images/school')}}/school3.jpg"
                    alt="Schools">
                <img class="object-cover  rounded-xl  shadow-xl" src="{{asset('storage/images/school')}}/school4.jpg"
                    alt="Schools">
                <img class="object-cover  rounded-xl  shadow-xl" src="{{asset('storage/images/school')}}/school5.jpg"
                    alt="Schools">
                <img class="object-cover  rounded-xl  shadow-xl" src="{{asset('storage/images/school')}}/school6.jpg"
                    alt="Schools">
                <img class="object-cover  rounded-xl  shadow-xl" src="{{asset('storage/images/school')}}/school7.jpg"
                    alt="Schools">
                <img class="object-cover  rounded-xl  shadow-xl" src="{{asset('storage/images/school')}}/school8.jpg"
                    alt="Schools">
                <img class="object-cover  rounded-xl  shadow-xl" src="{{asset('storage/images/school')}}/school9.jpg"
                    alt="Schools">
                <img class="object-cover  rounded-xl  shadow-xl" src="{{asset('storage/images/school')}}/school10.jpg"
                    alt="Schools">
                <img class="object-cover  rounded-xl  shadow-xl" src="{{asset('storage/images/school')}}/school11.jpg"
                    alt="Schools">
                <img class="object-cover  rounded-xl  shadow-xl" src="{{asset('storage/images/school')}}/school12.jpg"
                    alt="Schools">
            </div>
        </div>
    </div>
...
<div class="py-12">
    <div class="max-w-7xl mx-auto p-8 text-center">
        <h3 class="text-3xl text-pink-600 text-center">Everyone at Chinley Community Association is committed to
            ...
            our
            care.</h3>
        <h3 class="mt-4">We take safeguarding very seriously. If you are worried about a child, don’t wait. Contact Mr.
            Lambert or Mrs.
