                ...
                <div class="mx-auto max-w-md sm:max-w-3xl lg:max-w-none lg:w-1/2 lg:mx-0">
                    ...
                    <div class=" gap-4">
                        @if ($venue->use_external_website)
                            <p
                                class="mb-10 mx-auto text-gray-600 text-lg sm:text-xl md:max-w-xl lg:max-w-none relative z-10">
                            ...
                            <dl class="rounded-lg bg-white shadow-lg md:grid md:grid-cols-3 items-start">
                                ...
                                <div class="flex flex-col border-t border-gray-100 p-6 text-center sm:border-0 sm:border-l">
                                    ...
                                    <dd class="mt-3 text-gray-600 md:text-center">
                                        ...
                                        Minimum Booking: {{ $venue->minimum_booking }}
                                        {{ Str::plural('hour', $venue->minimum_booking) }}
                                    </dd>
                                </div>
                            </dl>
                        </div>
            ...
            @if (!$venue->use_external_website && false)
                <div class="relative max-w-screen-xl mx-auto px-4 py-12 sm:px-6 lg:pl-12 lg:pr-8">
                    <div class="md:ml-auto md:w-1/2 md:pl-10 mx-auto">
                        ...
                        @if ($venue->email)
                            <a href="mailto:{{ $venue->email }}" id="enquire"
                                class="mt-2 text-white text-3xl leading-9 font-extrabold sm:text-4xl sm:leading-10">
                                Enquire Here
                            </a>
                        @endif
