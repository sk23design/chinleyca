...
@section('content')
    ...
    <section class="relative">
        ...
        <div class=" z-100 w-full b-0 md:-mt-72 text-gray-100">
            @include('assets.curve')
        </div>
    </section>


    <section class="relative py-12 bg-gray-100 -mt-1">
        <div class="max-w-4xl px-8 mx-auto text-gray-600 ">
        ...
        <div class="max-w-6xl mx-auto px-8 mt-8">
            <div class="grid  md:grid-cols-3 gap-8">
                ...
                @for ($i = 0; $i < 3; $i++)
                    <div class="p-8 text-center bg-pink-{{ $i + 5 . '00' }} text-white rounded-lg">
